...
public class OmDestinationBo implements Serializable{
    ...
    //新增存放es中的关于产品信息的属性
//    private List<EsProProduct> esProProducts;
...
//    public List<EsProProduct> getEsProProducts() {
//        return esProProducts;
//    }
//
//    public void setEsProProducts(List<EsProProduct> esProProducts) {
//        this.esProProducts = esProProducts;
//    }

    @Override
    public String toString() {
        return "OmDestinationBo{" +
                "id='" + id + '\'' +
                ", parentid='" + parentid + '\'' +
                ", destid='" + destid + '\'' +
                ", destname='" + destname + '\'' +
                ...
                ", aliasid=" + aliasid +
                ", proProductBoList=" + proProductBoList +
                '}';
    }
}