...
/**
 * @ClassName： ProductVisitsCollection
 * @Description:
 * @Author: 史迪旻
 * @Date: Created in 2018-8-15 10:20
 * @Version: 1.0
 * @Modified By:
 */
@Data
@Document(collection = "ProductVisitsCollection")
public class ProductVisitsCollection implements Serializable {
    private static final long serialVersionUID = 1L;

    @Id
    private String id;

    private String projectType;     //项目类型：1.pc 2.h5
    private String userAgent;       //浏览器参数
    private String ip;              //用户IP
    private Date createDate;      //创建时间
    private String orgId;           //当前访问旅行社ID
    private String orgName;         //当前访问旅行社名称
    private String loginStatus;     //登录状态：0.未登录 1.登录
